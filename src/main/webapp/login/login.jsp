...
//      点击切换验证码
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/VerificationCode/createCaptchaImage?time=" + new Date().getTime());
            });

            $("#loginButtonId").click(function () {
                var newVar = $("#loginForm").serialize();
                console.log(newVar);
                $.ajax({
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/VerificationCode/createCaptchaImage">
